import { B as InvalidImageService, D as ExpectedNotESMImage, E as ExpectedImageOptions, I as IncompatibleDescriptorOptions, O as FailedToFetchRemoteImageDimensions, T as ExpectedImage, V as LocalImageUsedWrongly, X as NoImageMetadata, d as isRemotePath, f as joinPaths, gt as AstroError, h as removeQueryString, it as RemoteImageNotAllowed, mt as UnsupportedImageFormat, pt as UnsupportedImageConversion, q as MissingImageDimension, t as isRemoteAllowed } from "./remote_CM7qqFvg.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_Ckt4J2hQ.mjs").catch((e) => {
